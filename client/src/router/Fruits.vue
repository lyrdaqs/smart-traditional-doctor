...
<template>
        ...
        <DetailHeader img_url="/src/assets/pics/bg_1.jpg" header_title="خواص میوه ها"></DetailHeader>
                ...
                <div class="row">
                    <div class="col-lg-8 ftco-animate">
                        <div class="row">
                            ...
                            <div v-for="fruit in fruits" :key="fruit._id" class="col-md-12 d-flex ftco-animate">
                                <div class="blog-entry align-self-stretch d-md-flex">
                                    <router-link :to="getHrefUrl(fruit._id)" class="block-20"
                                     :style="{ backgroundImage: `url('/src/assets/pics/${fruit.img}')` }">
                                    </router-link>
                                    <div class="text d-block pr-md-4">
                                        <div class="meta mb-3">
                                            <div><a href="#">{{ fruit.datetime }}</a></div>
                                            <div><a href="#">کاربر</a></div>
                                            <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
                                        </div>
                                        <h3 class="heading"><a href="#">{{ fruit.title }}</a></h3>
                                        <p>{{ fruit.description }}</p>
                                        <p><router-link :to="getHrefUrl(fruit._id)" class="btn btn-primary py-2 px-3">بیشتر بخوانید</router-link>
                                        </p>
                                    </div>
                                </div>
                            </div>
