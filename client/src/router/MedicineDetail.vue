<script setup>
    ...
    const fetchMedicine = async () => {
        try {
            ...
            const response = await axios.get(`http://127.0.0.1:8000/medicines/${medicineId}`);
    ...
    const addComment = async () => {
        try {
            setToken()
            const medicineId = route.params.id; 
            await axios.post(`http://127.0.0.1:8000/medicines/${medicineId}/comments/add`, {"content": comment.value});
            comment.value = ""
            await fetchMedicine()
        } catch (err) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 ftco-animate">
                        <h2 class="mb-3">{{ medicine.title }}</h2>
                        <p>
                            <img :src="getImageUrl(medicine.img)" alt="" class="img-fluid">
                        </p>
                        ...
                        <div class="pt-5 mt-5">
                            ...
                            <ul class="comment-list">
                                ...
                                <li class="comment" v-for="comment in medicine.comments">
                                    <div class="vcard bio">
