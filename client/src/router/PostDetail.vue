<script setup>
    ...
    const fetchPost = async () => {
        try {
            ...
            const response = await axios.get(`http://127.0.0.1:8000/trad_posts/${postId}`);
    ...
    const addComment = async () => {
        try {
            setToken()
            const postId = route.params.id; 
            await axios.post(`http://127.0.0.1:8000/trad_posts/${postId}/comments/add`, {"content": comment.value});
            comment.value = ""
            await fetchPost()
        } catch (err) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 ftco-animate">
                        ...
                        <p>
                            <img :src="getImageUrl(post.img_detail)" alt="" class="img-fluid">
                        </p>
                        <div v-html="htmlContent"></div>

                        <p v-for="img in post.img_detail_items">
                            <img :src="getImageUrl(img)" alt="" class="img-fluid">
                        </p>

                        <div class="tag-widget post-tag-container mb-5 mt-5">
                            <div class="tagcloud">
                                <router-link :to="getHrefTag(tag)" v-for="tag in post.tags" class="tag-cloud-link">{{ tag }}</router-link>
                            </div>
                        </div>
                        ...
                        <div class="pt-5 mt-5">
                            ...
                            <ul class="comment-list">
                                ...
                                <li class="comment" v-for="comment in post.comments">
                                    <div class="vcard bio">
